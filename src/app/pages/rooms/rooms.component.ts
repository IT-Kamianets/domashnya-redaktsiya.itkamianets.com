	...
	protected readonly rooms: RoomCard[] = [
		{
			...
			imageAlt: 'Демо номер Делюкс із балконом у Домашня Редакція',
		},
		{
			...
			imageAlt: 'Демо номер Стандарт бізнес у Домашня Редакція',
		},
		{
			name: 'Преміум номер',
			description:
			...
			imageAlt: 'Демо Преміум номер у Домашня Редакція',
		},
	];
